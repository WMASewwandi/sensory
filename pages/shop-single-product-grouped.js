...
export default function ShopSingleProductGrouped() {
        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            <div className="single-product-info">
              <h4 className="title">Product Grouped</h4>
                ...
                <table>
                  <tbody>
                    <tr>
                      ...
                      <td className="thumb"><img src="/assets/img/shop/details/nav1.jpg" alt="Image" /></td>
                    ...
                    <tr>
                      ...
                      <td className="thumb"><img src="/assets/img/shop/details/nav2.jpg" alt="Image" /></td>
                      <td className="title"><a href="#/">Porcelain Small Bowls</a></Link></td>
                      <td className="price"><span className="pro-price"><span className="old">£120.00</span><span className="new">£96.00</span></span></td>
                    </tr>
                    <tr>
                      <td className="choose"><input type="checkbox" /></td>
                      <td className="quantity">1</td>
                      <td className="thumb"><img src="/assets/img/shop/details/nav3.jpg" alt="Image" /></td>
                      <td className="title"><a href="#/">Walnut Cutting Board</a></Link></td>
