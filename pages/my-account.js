...
export default function MyAccount() {
  ...
  return (
    <Layout title="My Account - Kidol - Kids Toys Store eCommerce HTML Template">
              ...
              <div className="col-lg-3 col-md-4">
                <nav>
                  <div className="myaccount-tab-menu nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button className="nav-link" onClick={() => router.push('/login-register')} type="button">Logout</button>
                  </div>
                </nav>
              </div>
                ...
                <div className="tab-content" id="nav-tabContent">
                  <div className="tab-pane fade show active" id="dashboad" role="tabpanel" aria-labelledby="dashboad-tab">
                    <div className="myaccount-content">
                      ...
                      <div className="welcome">
                        <p>Hello, <strong>Alex Tuntuni</strong> (If Not <strong>Tuntuni !</strong><Link href="/login-register" className="logout"> Logout</Link>)</p>
                      </div>
                        ...
                        <table className="table table-bordered">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>Pending</td>
                              <td>$3000</td>
                              <td><Link href="/shop-cart" className="check-btn sqr-btn ">View</Link></td>
                            </tr>
                            <tr>
                              <td>2</td>
                              <td>July 22, 2018</td>
                        ...
                        <table className="table table-bordered">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>Aug 22, 2022</td>
                              <td>Yes</td>
                              <td><a href="#/" className="check-btn sqr-btn"><i className="fa fa-cloud-download"></i> Download File</a></Link></td>
                            </tr>
                            <tr>
                  ...
                  <div className="tab-pane fade" id="address-edit" role="tabpanel" aria-labelledby="address-edit-tab">
                    <div className="myaccount-content">
                      ...
                      <a href="#/" className="check-btn sqr-btn"><i className="fa fa-edit"></i> Edit Address</a></Link>
                    </div>
                  </div>
