...
export default function ShopSingleProductVariable() {
              ...
              <table className="table">
                <tbody>
                  <tr>
                    ...
                    <td>Orange Flaver <i className="fa fa-angle-down"></i></td>
                  </tr>
                  <tr>
                    <th scope="row">Size:</th>
                    <td>Medium Size With Tube <i className="fa fa-angle-down"></i></td>
                  </tr>
                  <tr>
                    <th scope="row">Color:</th>
                    <td>Red &amp; Black <i className="fa fa-angle-down"></i></td>
                  </tr>
                </tbody>
              </table>
